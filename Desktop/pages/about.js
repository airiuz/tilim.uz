        ...
        <div className="bg_about dark:bg-none flex-1 flex flex-col">
          <div className="dark:bg-[#232831] pb-24 flex-1 pt-[30px] px-4">
            <div className="max-w-[936px] mx-auto">
              <p className="text-[#273A5D] dark:text-darkTernary text-[48px] font-bold">
                Loyiha haqida
              </p>
              <p className="mt-[20px] dark:text-darkTernary">
              ...
              <div className="mt-[40px] dark:text-darkTernary">
                <p className="text-[#273A5D] dark:text-darkTernary text-[36px] font-bold">
...
export async function getServerSideProps({ req }) {
  ...
  if (req.headers.host === "www.tilim.uz" && device) {
    return { redirect: { destination: "https://m.tilim.uz/about/" } };
  }

          ...
          <div className="bg-white rounded-xl max-w-[1000px] mx-auto px-[100px] py-[50px] mb-[100px] mt-[40px]">
            ...
            <div className="space-y-[15px]">
              <p className="mt-[20px]">
                ...
                shaxsning erkin rivojlanishi prinsiplariga asoslangan. <br />{" "}
              ...
              <p>
                ...
                <br /> 2.1. Berilgan matnning imlo xatolari mavjud yoki
                yo‘qligini tekshirish, universal izohli lug‘at, lotin alifbosida
                keltirilgan matnni kirill alifbosiga o‘girib berish (shu o‘rinda
                kirill alifbosidagi matnni lotin alifbosiga o‘girish), matn
                tahriri. <br />
              ...
              <p>
                ...
                to‘liq izoh olish; <br />- Tizim tomonidan ko‘rsatiladigan
                imloviy xatolar tekshirish, onlayn tahrirlash va boshqa xizmat
                turlaridan foydalanish;
                <br />- Tizimning kamchiliklarini ko‘rsatish (qayta aloqa
                bo‘limi) hamda izohli lug‘at omborini to‘ldirish;
                <br />
                ...
                foydalanuvchilar ARM xodimlari tomonidan tan olingan teng
                qiymatli xuddi shunday hujjat va materiallar bilan
                o‘zgartirishlari (shu jumladan, nusxalari bilan) kerak bo‘ladi.
                Buning imkoni bo‘lmagan hollarda ularning qiymati 5 barobar
                narxda undiriladi. Ko‘p miqdorli (bir necha barobar ko‘p
                miqdordagi to‘lov) amaldagi belgilangan hujjatlar asosida
                yo‘qotilgan va zarar ko‘rgan nashrlarning bahosidan kelib
                chiqqan holda ARM xodimlari yoki jalb etilgan mutaxassislar
              ...
              <p>
                ...
                foydalanishni ta’minlash hamda ularni saqlash va hisobot
                ishlarini amalga oshirish, izohli lug‘atni yuritish;
                <br />- foydalanuvchilarga yuqorida ko‘rsatib o‘tilgan turdagi
                xizmatlardan foydalanishlarini ta’minlashi;
                <br />- foydalanuvchilarning talablarini o‘rganish va imkon
                qadar qondirib borish;
                <br />- xizmatlarni mukammallashtirish maqsadida
                foydalanuvchilar bilan ishlashning turli individual va guruhli
                shaklini qo‘llash;
                <br />- foydalanuvchilarga xizmat ko‘rsatishda yuqori madaniyat
                namunasini ko‘rsatish va kasb mahoratini ta’minlash;
                <br />- kerakli axborotlarni mustaqil ravishda izlashni
                o‘rgatish bo‘yicha ko‘nikmalarni rivojlantirish uchun sharoit
                yaratish;
                <br />- tizimning ijobiy qiyofasini yaratishga ko‘maklashish,
                ARM tomonidan ko‘rsatiladigan xizmatlarni va fondlarni targ‘ib
                qilish, foydalanuvchilarning talablarini o‘rganish va ularning
                xohishlarini inobatga olgan holda yangidan-yangi xizmat
                turlarini yaratib borish.
              </p>
            </div>
          </div>
        </div>
...
export async function getServerSideProps({ req }) {
  ...
  if (req.headers.host === "www.tilim.uz" && device) {
    return { redirect: { destination: "https://m.tilim.uz/politics/" } };
  }
